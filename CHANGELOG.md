...
### Aggiunto
- Stati Uniti divisi per stato: al posto dell'unica regione "Stati Uniti (contigui)" (oltre 2 GB) ci sono 48 stati e il Distretto di Columbia, oltre ad Alaska e Hawaii, da scaricare uno per uno; ora hanno anche i numeri civici. Chi ha già scaricato la vecchia regione la trova ancora tra le nazioni scaricate, utilizzabile ma senza più aggiornamenti, con "Scegli le regioni" per passare agli stati.
